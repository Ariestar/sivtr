...
///
/// Mouse capture on Windows Terminal reports passive pointer movement. Those
/// events do not change any sivtr state, so letting them escape this function
/// would needlessly trigger the Windows full-frame redraw policy.
