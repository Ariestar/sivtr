...
- *(capture)* record commands through a pty proxy ([#334](https://github.com/Ariestar/sivtr/pull/334))
- *(agents)* support Command Code cmdc sessions ([#327](https://github.com/Ariestar/sivtr/pull/327))
...
- *(deps)* update dependency @astrojs/starlight to v0.42.3 ([#351](https://github.com/Ariestar/sivtr/pull/351))
- *(share)* exclude unbound workspace sessions ([#347](https://github.com/Ariestar/sivtr/pull/347))
- *(deps)* update dependency @astrojs/starlight to v0.42.2 ([#336](https://github.com/Ariestar/sivtr/pull/336))
- *(deps)* update dependency astro to v7.3.3 ([#329](https://github.com/Ariestar/sivtr/pull/329))
...
- *(cursor)* parse composer role/message transcript envelopes ([#252](https://github.com/Ariestar/sivtr/pull/252))
- *(archive)* single-flight freshness gate + fail-open readers ([#280](https://github.com/Ariestar/sivtr/pull/280))

### Other

- remove local web UI + JSON API ([#275](https://github.com/Ariestar/sivtr/pull/275)), focus on TUI ([#294](https://github.com/Ariestar/sivtr/pull/294))
- *(deps)* update rust crate rmcp to v3.4.0 ([#326](https://github.com/Ariestar/sivtr/pull/326))
- *(deps)* update dependency wrangler to v4.136.3 ([#350](https://github.com/Ariestar/sivtr/pull/350))
- *(deps)* update dependency marked to v18.0.14 ([#348](https://github.com/Ariestar/sivtr/pull/348))
- *(deps)* update dependency wrangler to v4.136.2 ([#349](https://github.com/Ariestar/sivtr/pull/349))
- *(deps)* update dependency @cloudflare/workers-types to v5.20260922.1 ([#346](https://github.com/Ariestar/sivtr/pull/346))
- *(deps)* update dependency wrangler to v4.136.1 ([#345](https://github.com/Ariestar/sivtr/pull/345))
- *(deps)* update dependency @cloudflare/workers-types to v5.20260921.1 ([#344](https://github.com/Ariestar/sivtr/pull/344))
- *(deps)* update dependency @cloudflare/workers-types to v5.20260920.1 ([#342](https://github.com/Ariestar/sivtr/pull/342))
- *(deps)* update release-plz/action action to v0.5.139 ([#341](https://github.com/Ariestar/sivtr/pull/341))
- *(deps)* update dependency @cloudflare/workers-types to v5.20260919.1 ([#340](https://github.com/Ariestar/sivtr/pull/340))
- *(deps)* update dependency @types/node to v24.13.6 ([#338](https://github.com/Ariestar/sivtr/pull/338))
- *(deps)* update dependency @types/node to v26.6.2 ([#339](https://github.com/Ariestar/sivtr/pull/339))
- *(deps)* update dependency wrangler to v4.135.0 ([#337](https://github.com/Ariestar/sivtr/pull/337))
- *(deps)* update dependency @cloudflare/workers-types to v5.20260918.1 ([#335](https://github.com/Ariestar/sivtr/pull/335))
- *(deps)* update dependency wrangler to v4.134.0 ([#333](https://github.com/Ariestar/sivtr/pull/333))
- *(deps)* update release-plz/action action to v0.5.138 ([#332](https://github.com/Ariestar/sivtr/pull/332))
- *(deps)* update dependency @cloudflare/workers-types to v5.20260917.1 ([#331](https://github.com/Ariestar/sivtr/pull/331))
- *(deps)* update dependency wrangler to v4.133.0 ([#330](https://github.com/Ariestar/sivtr/pull/330))
- *(deps)* update dependency @types/vscode to v1.138.0 ([#328](https://github.com/Ariestar/sivtr/pull/328))
