...
| [MCP cross-session recovery](/playbooks/mcp-cross-session-recovery/) | The agent searches MCP memory, saves a named WorkSet, and expands cited evidence after a new session. |
